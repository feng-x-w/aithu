...
<template>
  <div class="user_login">
    <!--<div class="dd"><img src="../../assets/backgroundImage.jpg" width="100%"/></div>-->
    <div class="top">
      {{$t('tianfu.eng')}}
    </div>
    <div class="mid">
      <div class="midLeft">
        ...
        <el-form :model="loginForm" :rules="loginRules" ref="loginForm">
          <el-form-item prop="username">
            <el-input v-model="loginForm.username" name="username" :placeholder="$t('UserLogin.inputID')" auto-complete="on"></el-input><!--//请输入用户名/手机号-->
          </el-form-item>

          <el-form-item prop="password">
            <el-input v-model="loginForm.password" type="password" name="password" :placeholder="$t('UserLogin.inputPass')" auto-complete="on"></el-input><!--//请输入密码-->
          </el-form-item>

          <el-form-item>
            <el-button type="primary" @click="handleLogin">{{$t('UserLogin.log')}}</el-button><!--登录-->
          </el-form-item>
        </el-form>
      </div>
      <div class="midRight">
